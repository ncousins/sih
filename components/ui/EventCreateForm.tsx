    ...
    <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1">
          ...
          <input
            name="title"
            required
            placeholder="GBS Skills Summit 2026"
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm font-heading font-semibold text-navy">
          Event image <span className="font-normal text-slate/60">(optional, square)</span>
        </label>
      ...
      <div>
        <button
          type="submit"
          disabled={submitting}
          className="bg-navy text-white text-sm font-heading font-semibold px-5 py-2.5 rounded hover:bg-navy/90 transition-colors cursor-pointer disabled:opacity-60"
        >
